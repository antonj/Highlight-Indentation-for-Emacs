...
(defun highlight-indentation-guess-offset ()
  ...
  (cond ((and (derived-mode-p '(python-base-mode)) (boundp 'python-indent))
         python-indent)
        ((and (derived-mode-p '(python-base-mode)) (boundp 'py-indent-offset))
         py-indent-offset)
        ((and (derived-mode-p '(python-base-mode)) (boundp 'python-indent-offset))
         python-indent-offset)
        ((and (derived-mode-p '(ruby-base-mode)) (boundp 'ruby-indent-level))
         ruby-indent-level)
        ...
        ((and (eq major-mode 'coffee-mode) (boundp 'coffee-tab-width))
         coffee-tab-width)
        ((and (derived-mode-p '(js-base-mode)) (boundp 'js-indent-level))
         js-indent-level)
